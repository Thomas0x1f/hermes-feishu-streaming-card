...
- Pending real Feishu acceptance: private repair/restart, group initiator repair/restart, changed-operator rejection, recheck, normal footer snapshot, topic, cron, and profile route mismatch. These are not claimed as verified here.
